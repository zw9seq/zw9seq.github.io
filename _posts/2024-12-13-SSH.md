...
The ssh tool is mainly used for managing remote servers via an **encrypted connection**. This means that the traffic traveling from the client to the server, and vice versa, is encrypted and cannot be viewed in plain text as with older services.  
